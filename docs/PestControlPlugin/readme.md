# Pest Control Script – CupidBot RuneLite Client

![img.png](assets/img.png)

The **Pest Control Script** automates the Old School RuneScape Pest Control mini-game using the CupidBot RuneLite client.
...
| **Inventory Setup**       | Loads gear and inventory from a predefined CupidBot setup.                  |
...
- Properly configured **inventory setup** in CupidBot
...
## Disclaimer
This script is intended for use within the **CupidBot RuneLite Client** only.

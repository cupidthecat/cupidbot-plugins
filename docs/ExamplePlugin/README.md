...
This plugin serves as a comprehensive template and reference for developing CupidBot plugins. It demonstrates the complete plugin architecture including configuration, scripting, overlay rendering, and proper RuneLite integration.
...
@PluginDescriptor(
    ...
    description = "CupidBots Example Plugin", // A brief description of the plugin (optional, default is '')
    tags = {"example", "cupidbot"}, // Tags to categorize the plugin (optional, default is '')
...
```
src/main/java/net/runelite/client/plugins/cupidbot/example/
...
src/main/resources/net/runelite/client/plugins/cupidbot/example/
└── docs/

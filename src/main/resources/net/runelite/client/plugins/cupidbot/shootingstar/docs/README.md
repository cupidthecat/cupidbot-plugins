...
![preview](https://azpublicfiles.blob.core.windows.net/cupidbot/shooting-star-preview.gif)

Shooting stars are a world event in Old School RuneScape, where players can mine fallen stars for rewards and experience. This plugin helps locate and mine shooting stars by integrating with star location providers and automating navigation.
...
- **Antiban Support**: Uses CupidBot's antiban system for safer, more human-like behavior.
...
## Setup
1. Make sure you have CupidBot and this plugin installed.
...
- **Other issues:** Try restarting your client, check for plugin updates, or create an issue on the cupidbot-hub repository.

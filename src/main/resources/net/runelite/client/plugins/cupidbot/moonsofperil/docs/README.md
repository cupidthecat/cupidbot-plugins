...
- The plugin is on the main CupidBot release.
...
- Enable Debug Logs in the plugin configuration, record a clip or video, and post it in the discord Bug Reports channel, following the CupidBot template for Bug Reporting.
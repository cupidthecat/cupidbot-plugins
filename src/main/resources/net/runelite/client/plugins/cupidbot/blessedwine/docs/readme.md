...
2. Start the plugin from the CupidBot plugin panel
...
- **Dependencies**: Core CupidBot functionality only
- **Compatibility**: RuneLite with CupidBot integration

## Support

For issues, questions, or feature requests, please refer to the main CupidBot repository or contact the plugin author.

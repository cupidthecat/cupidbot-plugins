package net.runelite.client.plugins.cupidbot.shootingstar.model;
...
import net.runelite.client.plugins.cupidbot.shootingstar.ShootingStarPanel;
	...
	private MouseAdapter createMouseOptions(Star starData, Color backgroundColor)
	{
		return new MouseAdapter()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				...
				{
					CupidBot.hopToWorld(starData.getWorld());
				}
			}
		};
	}

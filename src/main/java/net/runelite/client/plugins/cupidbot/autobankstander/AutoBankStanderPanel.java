package net.runelite.client.plugins.cupidbot.autobankstander;

import lombok.extern.slf4j.Slf4j;
import net.runelite.api.Skill;
import net.runelite.client.game.SkillIconManager;
import net.runelite.client.plugins.cupidbot.autobankstander.config.ConfigData;
...
public class AutoBankStanderPanel extends PluginPanel {
    ...
    private void updateFletchingConfiguration(FletchingMode mode) {
        ...
        switch (mode) {
            ...
            case BOLTS:
                JComboBox<net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType> fletchingBoltDropdown =
                    new JComboBox<>(net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType.values());
                fletchingBoltDropdown.setSelectedItem(currentConfig.getFletchingBoltType());
                fletchingBoltDropdown.addActionListener(e -> {
                    currentConfig.setFletchingBoltType((net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType) fletchingBoltDropdown.getSelectedItem());
                });

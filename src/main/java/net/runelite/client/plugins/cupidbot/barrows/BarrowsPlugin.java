...
@PluginDescriptor(
        ...
        iconUrl = "BarrowsPlugin/assets/icon.png", // URL to plugin icon shown in client (optional)
        cardUrl = "BarrowsPlugin/assets/card.png", // URL to plugin card image for website (optional)

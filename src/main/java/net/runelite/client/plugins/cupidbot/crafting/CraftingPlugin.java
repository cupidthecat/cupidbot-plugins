package net.runelite.client.plugins.cupidbot.crafting;
...
import net.runelite.client.plugins.cupidbot.crafting.enums.Activities;
import net.runelite.client.plugins.cupidbot.crafting.scripts.*;
...
@PluginDescriptor(
        ...
        description = "CupidBot crafting plugin",
        tags = {"skilling", "cupidbot", "crafting"},
        authors = { "Mocrosoft" },
        version = CraftingPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "CraftingPlugin/assets/card.png",
        iconUrl = "CraftingPlugin/assets/icon.png",

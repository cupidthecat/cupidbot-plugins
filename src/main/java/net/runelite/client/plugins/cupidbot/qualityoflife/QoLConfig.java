...
import net.runelite.client.plugins.cupidbot.qualityoflife.enums.CraftingItem;
import net.runelite.client.plugins.cupidbot.qualityoflife.enums.FletchingItem;

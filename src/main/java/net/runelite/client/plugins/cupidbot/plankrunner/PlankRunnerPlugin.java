...
import net.runelite.client.plugins.cupidbot.plankrunner.enums.Plank;
import net.runelite.client.plugins.cupidbot.plankrunner.enums.SawmillLocation;
...
@PluginDescriptor(
        ...
        description = "CupidBot plank runner plugin",
        tags = {"money making", "cupidbot"},

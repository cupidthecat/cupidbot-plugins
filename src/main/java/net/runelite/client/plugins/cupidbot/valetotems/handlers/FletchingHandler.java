...
import net.runelite.client.plugins.cupidbot.valetotems.utils.FletchingItemMapper;
...
public class FletchingHandler {
    ...
    private static int getWidgetHotkey(int childId) {
        try {
            ...
            String hotkeyText = CupidBot.getClientThread().invoke(() -> {
    ...
    private static boolean interactWithWidget(int childId, String description) {
        try {
            ...
            if (hotkey != -1) {
                ...
                CupidBot.log("Used keyboard shortcut '" + getKeyName(hotkey) + "' for: " + description);
                return true;
            }

            // Fallback to widget clicking
            Rs2Widget.clickWidget(FLETCHING_INTERFACE_WIDGET_ID, childId);
            CupidBot.log("Used widget click (no hotkey available) for: " + description);
            return true;
    ...
    public static boolean startFletching() {
        try {
            ...
            if (used) {
                ...
                CupidBot.log("Fletching interface opened");
    ...
    public static boolean selectBow(int quantity) {
        try {
            ...
            if (quantity == 1) {
                ...
                CupidBot.log("Selected 1 bow");
            } else if (quantity == 5) {
                interactWithWidget(QUANTITY_5_CHILD_ID, "5 bows");
                CupidBot.log("Selected 5 bows");
            } else if (quantity == 10) {
                interactWithWidget(QUANTITY_10_CHILD_ID, "10 bows");
                CupidBot.log("Selected 10 bows");
            } else if (quantity >= 28) {
                interactWithWidget(QUANTITY_ALL_CHILD_ID, "all bows");
                CupidBot.log("Selected all bows");
            } else {
                String[] widgetInfo = CupidBot.getClientThread().invoke(() -> {
                ...
                if (widgetInfo != null) {
                    ...
                    if (currentText != null) {
                        ...
                        if (Integer.parseInt(currentQuantity) == quantity || hasActions) {
                            ...
                            CupidBot.log("Selected other quantity");
                        } else {
                            ...
                            CupidBot.log("Selected other quantity1");
                        }
                    } else {
                        interactWithWidget(QUANTITY_X_CHILD_ID, "X");
                        sleepUntil(() -> Rs2Widget.getChildWidgetText(162, 42).contains("Enter amount"), 2000);
                        ...
                        sleepGaussian(300,100);
                        Rs2Keyboard.keyPress(KeyEvent.VK_ENTER);
                        CupidBot.log("Selected other quantity2");
                    }
                } else {
                    CupidBot.log("No other quantity widget found");
                }
            }
            ...
            if (!Rs2Widget.handleProcessingInterface(bowAction)) {
                CupidBot.log("Failed to select " + bowAction + " from fletching interface");
                return false;
            }
            CupidBot.log("Selected " + bowAction);
     ...
     * @return true if fletching completed successfully
     */
    public static boolean fletchBows(int quantity, net.runelite.client.plugins.cupidbot.valetotems.models.GameSession gameSession) {
        try {
     ...
     * @return true if 4 bows were successfully fletched
     */
    public static boolean fletchBowsForOneTotem(net.runelite.client.plugins.cupidbot.valetotems.models.GameSession gameSession) {
     ...
     * @return true if fletching while walking was initiated
     */
    public static boolean startFletchingWhileWalking(int bowsNeeded, net.runelite.client.plugins.cupidbot.valetotems.models.GameSession gameSession) {
        try {

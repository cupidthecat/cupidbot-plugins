package net.runelite.client.plugins.cupidbot.leftclickcast;
...
public class LeftClickCastPlugin extends Plugin
{
	...
	{
		// CupidBotConfigPanel renders boolean checkboxes from raw stored values; missing keys read as false
	...
	private void onSlotHotkey(int index)
	{
		...
		if (spell != null && config.spell() != spell)
		{
			...
			// CupidBotConfigPanel doesn't refresh individual widgets on ConfigChanged — force a rebuild
	...
	private void onEnabledToggleHotkey()
	{
		...
		// CupidBotConfigPanel doesn't subscribe to ConfigChanged for individual checkbox refresh, but it does

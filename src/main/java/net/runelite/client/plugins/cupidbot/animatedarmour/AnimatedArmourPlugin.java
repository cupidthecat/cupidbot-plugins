package net.runelite.client.plugins.cupidbot.animatedarmour;
...
@PluginDescriptor(
        ...
        tags = {"animated armour", "cupidbot", "warrior guild"},
        authors = {"See1Duck"},
        version = AnimatedArmourPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "AnimatedArmourPlugin/assets/card.png",
        iconUrl = "AnimatedArmourPlugin/assets/icon.png",

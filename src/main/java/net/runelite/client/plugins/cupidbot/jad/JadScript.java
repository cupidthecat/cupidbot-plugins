package net.runelite.client.plugins.cupidbot.jad;
...
public class JadScript extends Script {
    ...
    public boolean run(JadConfig config) {
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                List<Rs2NpcModel> jadNpcs = CupidBot.getRs2NpcCache().query()
    ...
    private void handleHealerInteraction() {
        var healer = CupidBot.getRs2NpcCache().query()
        ...
        if (healer != null) {
            ...
            if (npc == null || npc.getName().contains("hurkot")) {
                var jad = CupidBot.getRs2NpcCache().query()
                        .where(n -> n.getName() != null && n.getName().toLowerCase().contains("jad"))
                        .nearest();
                if (jad != null) {
                    jad.click("Attack");

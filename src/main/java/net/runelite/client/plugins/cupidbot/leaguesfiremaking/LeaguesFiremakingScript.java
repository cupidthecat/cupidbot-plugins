package net.runelite.client.plugins.cupidbot.leaguesfiremaking;
...
public class LeaguesFiremakingScript extends Script {
    ...
    private void handleBanking(LeaguesFiremakingConfig config) {
        ...
        if (!Rs2Bank.hasItem(TINDERBOX_ID)) {
            ...
            CupidBot.log("No tinderbox found in bank.");
            shutdown();
            return;
        }
        ...
        if (!Rs2Bank.hasItem(activeLogType.getItemId())) {
            ...
            CupidBot.log("No " + activeLogType.getLogName() + " found in bank.");
            shutdown();
            return;
        }

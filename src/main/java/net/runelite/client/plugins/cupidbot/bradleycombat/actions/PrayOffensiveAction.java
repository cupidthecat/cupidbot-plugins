...
import net.runelite.client.plugins.cupidbot.bradleycombat.enums.PrayerStyle;
...
import static net.runelite.client.plugins.cupidbot.util.prayer.Rs2Prayer.isPrayerActive;
import static net.runelite.client.plugins.cupidbot.util.prayer.Rs2Prayer.toggle;

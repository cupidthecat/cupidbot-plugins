...
public class CharterCrafterOverlay extends OverlayPanel {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        int currentMagicXp = CupidBot.getClient() != null ? CupidBot.getClient().getSkillExperience(Skill.MAGIC) : 0;
        int currentCraftingXp = CupidBot.getClient() != null ? CupidBot.getClient().getSkillExperience(Skill.CRAFTING) : 0;

package net.runelite.client.plugins.cupidbot.mining.data;
...
public class MiningRockLocations {
    ...
    public static LocationOption getBestAccessibleLocation(Rocks rock) {
        return getBestAccessibleLocation(rock, Rs2Player.getWorldLocation());
    }

    public static LocationOption getBestAccessibleLocation(Rocks rock, WorldPoint playerLocation) {
    ...
    public static ResourceLocationOption getBestAccessibleResourceLocation(Rocks rock, int minResources) {
        ...
        List<net.runelite.client.plugins.cupidbot.mining.data.ResourceLocationOption> suitableLocations = accessibleLocations.stream()

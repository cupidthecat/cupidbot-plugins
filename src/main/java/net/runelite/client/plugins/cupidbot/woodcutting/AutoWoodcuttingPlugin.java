...
import net.runelite.client.plugins.cupidbot.woodcutting.Forestry.*;
...
@PluginDescriptor(
        ...
        description = "CupidBot woodcutting plugin",
        tags = {"Woodcutting", "cupidbot", "skilling"},
        authors = {"Mocrosoft"},
        version = AutoWoodcuttingPlugin.version,
        minClientVersion = "2.1.32",
        cardUrl = "AutoWoodcuttingPlugin/assets/card.jpg",
        iconUrl = "AutoWoodcuttingPlugin/assets/icon.jpg",
...
public class AutoWoodcuttingPlugin extends Plugin {
    ...
    private void addEvents() {
        var eventManager = CupidBot.getBlockingEventManager();

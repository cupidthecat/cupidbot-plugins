...
public final class Rs2Leprechaun {
    ...
    public static boolean openExchange() {
        ...
        if (leprechaun == null) {
            CupidBot.log("Tool Leprechaun not found nearby.");
            return false;
        }
    ...
    public static boolean withdrawCompost(int compostItemId) {
        ...
        if (childId == null) {
            CupidBot.log("Unsupported compost item ID for leprechaun withdrawal: " + compostItemId);
            return false;
        }
        ...
        if (compostWidget == null) {
            CupidBot.log("Compost widget not found in leprechaun interface.");
            closeExchange();
            return false;
        }

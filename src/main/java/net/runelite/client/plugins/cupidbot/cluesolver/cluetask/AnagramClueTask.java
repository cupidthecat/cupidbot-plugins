...
public class AnagramClueTask extends ClueTask {
    ...
    private void transitionToInteractionState() {
        ...
        } else if (clue.getNpcProvider() != null && CupidBot.getRs2NpcCache().query().withName(clue.getNpcName(clueScrollPlugin)).nearestOnClientThread() != null) {
    ...
    private boolean interactWithObject() {
        ...
        boolean interacted = CupidBot.getRs2TileObjectCache().query().interact(targetObject, "Search")
    ...
    private boolean interactWithNpc() {
        var targetNpc = CupidBot.getRs2NpcCache().query().withName(clue.getNpcName(clueScrollPlugin)).nearestOnClientThread();
        if (targetNpc == null) {

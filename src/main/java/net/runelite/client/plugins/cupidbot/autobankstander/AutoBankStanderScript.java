...
import net.runelite.client.plugins.cupidbot.autobankstander.processors.BankStandingProcessor;
...
import net.runelite.client.plugins.cupidbot.autobankstander.skills.magic.enchanting.EnchantingProcessor;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.magic.lunars.LunarsProcessor;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.herblore.HerbloreProcessor;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.FletchingProcessor;
...
public class AutoBankStanderScript extends Script {
    ...
    private void handleInitializing() {
        ...
        CupidBot.status = "Initializing..."; // tell the user we are starting up
    ...
    private void handleBanking() {
        ...
        CupidBot.status = "Banking..."; // tell the user we are handling banking
        ...
        if (bankingSuccess) {
            ...
            CupidBot.status = "No required items available";
            shutdown(); // stop the plugin
        }
    }
    ...
    private void handleProcessing() {
        ...
        CupidBot.status = processor.getStatusMessage(); // tell the user what we are doing
    ...
    private void handleErrorRecovery() {
        ...
        CupidBot.status = "Recovering from error..."; // tell the user we are fixing issues

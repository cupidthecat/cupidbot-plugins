...
@PluginDescriptor(
        ...
        cardUrl = "FarmTreeRunPlugin/assets/card.jpg",
        iconUrl = "FarmTreeRunPlugin/assets/icon.jpg",
...
public class FarmTreeRunPlugin extends Plugin {
    ...
    @Inject
    net.runelite.client.plugins.cupidbot.farmtreerun.FarmTreeRunScript FarmTreeRunScript;

package net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels;
...
public class XpChartPanel extends DashboardSection {
    ...
    private Skill restoreSkill(Skill fallback) {
        try {
            String raw = CupidBot.getConfigManager().getConfiguration(CONFIG_GROUP, K_CHART_SKILL);
    ...
    private int restoreWindowIndex() {
        try {
            String raw = CupidBot.getConfigManager().getConfiguration(CONFIG_GROUP, K_CHART_WINDOW_INDEX);

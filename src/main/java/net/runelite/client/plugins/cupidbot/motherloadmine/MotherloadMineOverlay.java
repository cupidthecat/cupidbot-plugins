...
import net.runelite.client.plugins.cupidbot.motherloadmine.MotherloadMineScript;
import static net.runelite.client.plugins.cupidbot.motherloadmine.MotherloadMineScript.status;

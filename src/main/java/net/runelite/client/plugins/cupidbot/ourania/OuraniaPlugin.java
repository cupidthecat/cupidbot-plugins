...
@PluginDescriptor(
	...
	iconUrl = "OuraniaPlugin/assets/icon.png",
	cardUrl = "OuraniaPlugin/assets/card.png",
...
public class OuraniaPlugin extends Plugin
{
	...
	public void onItemContainerChanged(ItemContainerChanged event)
	{
		...
		if (!getOuraniaAltarArea().contains(CupidBot.getClient().getLocalPlayer().getWorldLocation()))
		{
			previousInventoryRunes.clear();
			return;
		}

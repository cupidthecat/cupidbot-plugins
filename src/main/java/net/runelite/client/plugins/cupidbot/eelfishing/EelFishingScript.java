package net.runelite.client.plugins.cupidbot.eelfishing;

import net.runelite.api.gameval.ItemID;
import net.runelite.client.game.FishingSpot;
import net.runelite.client.plugins.cupidbot.CupidBot;
import net.runelite.client.plugins.cupidbot.Script;
import net.runelite.client.plugins.cupidbot.eelfishing.EelFishingConfig;
import net.runelite.client.plugins.cupidbot.eelfishing.enums.EelFishingSpot;
...
public class EelFishingScript extends Script {
    ...
    public boolean run(EelFishingConfig config) {
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            if (!super.run() || !CupidBot.isLoggedIn() || !Rs2Inventory.hasItem("bait") || !Rs2Inventory.hasItem("rod")) {
                return;
            }
...
//                return;
            ...
            if (config.fishingSpot().equals(EelFishingSpot.INFERNAL_EEL) && !hasRequiredGloves()) {
                CupidBot.log("You need ice gloves to fish infernal eels.");
                return;
            }
    ...
    private Rs2NpcModel findFishingSpot() {
        ...
        return CupidBot.getRs2NpcCache().query().withIds(ids).nearest();
    }

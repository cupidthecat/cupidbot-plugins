...
@PluginDescriptor(
        ...
        tags = {"tithe farming", "cupidbot", "skills", "minigame"},
        authors = { "Mocrosoft" },
        version = TitheFarmingPlugin.version,
        minClientVersion = "1.9.8.8",
        iconUrl = "TitheFarmingPlugin/assets/icon.png",
        cardUrl = "TitheFarmingPlugin/assets/card.png",
...
public class TitheFarmingPlugin extends Plugin {
    ...
    private final net.runelite.client.plugins.cupidbot.tithefarming.TitheFarmingScript titheFarmScript = new net.runelite.client.plugins.cupidbot.tithefarming.TitheFarmingScript();
    ...
    public void onItemContainerChanged(ItemContainerChanged event) {
        if (TitheFarmMaterial.getSeedForLevel() != null) {
            ...
            if (fruit != null) {
                net.runelite.client.plugins.cupidbot.tithefarming.TitheFarmingScript.fruits = fruit.getQuantity() - net.runelite.client.plugins.cupidbot.tithefarming.TitheFarmingScript.initialFruit;
            }
        }
    }
    ...
    public void onChatMessage(ChatMessage chatMessage)
    {
        ...
        if (message.contains("%")) {
            ...
            if (matcher.find()) {
                ...
                net.runelite.client.plugins.cupidbot.tithefarming.TitheFarmingScript.gricollerCanCharges = (int) (Float.parseFloat(percentage));
            }
        } else if (message.equalsIgnoreCase("Gricoller's can is already full.")) {
            net.runelite.client.plugins.cupidbot.tithefarming.TitheFarmingScript.gricollerCanCharges = 100;

...
public class DodgeProjectileScript extends Script {
    ...
    public boolean run(AIOFighterConfig config) {
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            int cycle = CupidBot.getClient().getGameCycle();
            ...
            WorldPoint playerLocation = CupidBot.getClientThread().invoke(() -> CupidBot.getClient().getLocalPlayer().getWorldLocation()); // replaceable with Rs2Player.getWorldLocation() ?

package net.runelite.client.plugins.cupidbot.autobankstander.config;

import com.google.gson.Gson;
import net.runelite.client.plugins.cupidbot.autobankstander.processors.SkillType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.magic.MagicMethod;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.magic.enchanting.BoltType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.herblore.enums.CleanHerbMode;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.herblore.enums.HerblorePotion;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.herblore.enums.Mode;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.herblore.enums.UnfinishedPotionMode;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.FletchingMode;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.ArrowType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BowType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.CrossbowType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.DartType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.JavelinType;
import net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.ShieldType;
...
public class ConfigData {
    ...
    private net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType fletchingBoltType = net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType.BRONZE;
    ...
    public net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType getFletchingBoltType() { return fletchingBoltType; }
    public void setFletchingBoltType(net.runelite.client.plugins.cupidbot.autobankstander.skills.fletching.enums.BoltType fletchingBoltType) { this.fletchingBoltType = fletchingBoltType; }

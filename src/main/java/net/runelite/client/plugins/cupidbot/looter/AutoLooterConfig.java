...
import net.runelite.client.plugins.cupidbot.looter.enums.FlaxLocations;
import net.runelite.client.plugins.cupidbot.looter.enums.LooterActivity;
import net.runelite.client.plugins.cupidbot.looter.enums.NatureRuneChestLocations;

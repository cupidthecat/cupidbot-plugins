package net.runelite.client.plugins.cupidbot.slayer.combat;

import lombok.extern.slf4j.Slf4j;
import net.runelite.api.events.NpcDespawned;
import net.runelite.client.plugins.cupidbot.CupidBot;
import net.runelite.client.plugins.cupidbot.api.npc.models.Rs2NpcModel;
import net.runelite.client.plugins.cupidbot.slayer.PrayerFlickStyle;
import net.runelite.client.plugins.cupidbot.slayer.SlayerConfig;
import net.runelite.client.plugins.cupidbot.slayer.SlayerPrayer;

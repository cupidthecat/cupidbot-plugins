...
@PluginDescriptor(
        ...
        tags = {"Wintertodt", "cupidbot", "firemaking", "minigame"},
        authors = {"Mocrosoft"},
        version = MWintertodtPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "MWintertodtPlugin/assets/card.jpg",
        iconUrl = "MWintertodtPlugin/assets/icon.jpg",
...
public class MWintertodtPlugin extends Plugin {
    ...
    private boolean isInWintertodtRegion() {
        return CupidBot.getClient().getLocalPlayer().getWorldLocation().getRegionID() == 6462;
    }

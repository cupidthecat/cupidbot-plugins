...
import net.runelite.client.plugins.cupidbot.eelfishing.EelFishingOverlay;
import net.runelite.client.plugins.cupidbot.eelfishing.EelFishingScript;
...
@PluginDescriptor(
        ...
        tags = {"fishing", "eel", "cupidbot"},
        authors = {"See1Duck"},
        version = EelFishingPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "EelFishingPlugin/assets/card.jpg",
        iconUrl = "EelFishingPlugin/assets/icon.jpg",

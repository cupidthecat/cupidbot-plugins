...
@PluginDescriptor(
        ...
        tags = {"mahogany", "homes", "construction", "contract", "minigame", "s1d", "see1duck", "cupidbot"},
		authors = {"See1Duck"},
        version = MahoganyHomesPlugin.version,
        minClientVersion = "2.0.13",
        cardUrl = "MahoganyHomesPlugin/assets/card.png",
        iconUrl = "MahoganyHomesPlugin/assets/icon.png",

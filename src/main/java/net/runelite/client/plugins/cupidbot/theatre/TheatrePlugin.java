package net.runelite.client.plugins.cupidbot.theatre;
...
import net.runelite.client.plugins.cupidbot.theatre.Bloat.Bloat;
import net.runelite.client.plugins.cupidbot.theatre.Maiden.Maiden;
import net.runelite.client.plugins.cupidbot.theatre.Nylocas.Nylocas;
import net.runelite.client.plugins.cupidbot.theatre.Sotetseg.Sotetseg;
import net.runelite.client.plugins.cupidbot.theatre.Verzik.Verzik;
import net.runelite.client.plugins.cupidbot.theatre.Xarpus.Xarpus;
...
@PluginDescriptor(
	...
	tags = {"ToB", "Theatre", "raids", "bloat", "verzik", "nylo", "xarpus", "sotetseg", "maiden", "cupidbot"},
	authors = {"Syntax"},

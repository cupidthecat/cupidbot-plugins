...
public class BlueDragonsOverlay extends OverlayPanel {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        Rs2NpcModel nearestDragon = CupidBot.getRs2NpcCache().query().withName("Blue dragon").nearestOnClientThread();
    ...
    private void drawSafeSpot(Graphics2D graphics) {
        LocalPoint localSafeSpot = LocalPoint.fromWorld(CupidBot.getClient().getTopLevelWorldView(), BlueDragonsScript.SAFE_SPOT);

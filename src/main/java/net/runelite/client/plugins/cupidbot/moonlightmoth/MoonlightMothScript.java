...
public class MoonlightMothScript extends Script {
    ...
    public boolean run(MoonlightMothConfig config) {
        ...
        CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            var itemManager = CupidBot.getItemManager();
    ...
    private void checkState(MoonlightMothConfig config) {
        CupidBot.status = "Checking current state...";
    ...
    private void handleBanking(MoonlightMothConfig config) {
        CupidBot.status = "Banking process initiated";
    ...
    private void handleShopping(MoonlightMothConfig config) {
        CupidBot.status = "Shopping process initiated";
    ...
    private void handleCatching(MoonlightMothConfig config) {
        CupidBot.status = "Catching Moonlight Moths...";
        ...
        CupidBot.getRs2NpcCache().query().withId(NpcID.MOTH_MOONLIGHT).where(moth -> {

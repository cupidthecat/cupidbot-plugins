            ...
            try {
                ...
                if (LootedTitanLastIteration) {
                    if (lastLootTime.plusSeconds(15).isBefore(Instant.now())) {
                        ...
                        CupidBot.log("30 seconds passed since last loot - trying again");
                    } else {
                ...
                if (looted && !LootedTitanLastIteration) {
                    ...
                    net.runelite.client.plugins.cupidbot.RoyalTitans.RoyalTitansShared.evaluateAndConsumePotions(config);
                    CupidBot.log("Looted the titans");
                }

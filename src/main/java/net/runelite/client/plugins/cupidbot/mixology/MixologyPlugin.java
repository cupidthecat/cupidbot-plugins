...
import net.runelite.client.plugins.cupidbot.mixology.enums.PotionType;
...
@PluginDescriptor(
        ...
        tags = {"herblore", "cupidbot", "mixology"},
        iconUrl = "MixologyPlugin/assets/icon.png",
        cardUrl = "MixologyPlugin/assets/card.png",

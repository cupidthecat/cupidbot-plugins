package net.runelite.client.plugins.cupidbot.aiofighter.shop;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                for (ShopItem item : shopItems) {
                    ...
                    int itemPrice = CupidBot.getRs2ItemManager().getPrice(item.getItemId());
                        ...
                        if (Rs2GrandExchange.walkToGrandExchange()) {
                            ...
                            if (Rs2GrandExchange.openExchange()) {
                                ...
                                for (ShopItem item : filteredList) {
                                    ...
                                    int gePrice = CupidBot.getRs2ItemManager().getGEPrice(item.getName());

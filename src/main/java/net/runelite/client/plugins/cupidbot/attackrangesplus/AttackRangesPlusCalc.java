package net.runelite.client.plugins.cupidbot.attackrangesplus;

import lombok.extern.slf4j.Slf4j;
import net.runelite.client.plugins.cupidbot.util.combat.Rs2Combat;
import net.runelite.client.plugins.cupidbot.util.combat.weapons.Melee;
import net.runelite.client.plugins.cupidbot.util.combat.weapons.Weapon;
import net.runelite.client.plugins.cupidbot.util.combat.weapons.WeaponsGenerator;
 ...
 *
 * <p><b>Player:</b> AUTO delegates to {@link Rs2Combat#getAttackRange()}, the maintained CupidBot
 ...
 * looked up from their equipped weapon id against the same weapon data CupidBot uses

...
@PluginDescriptor(
        ...
        iconUrl = "HerbiboarPlugin/assets/icon.png",
        cardUrl = "HerbiboarPlugin/assets/card.png",
...
public class HerbiboarPlugin extends Plugin {
    ...
    protected void startUp() throws AWTException {
        ClientThread clientThread = CupidBot.getClientThread();
        HerbiboarConfig config = provideConfig(CupidBot.getConfigManager());

        setStartTime(Instant.now());
        setStartXp(CupidBot.getClient().getSkillExperience(Skill.HUNTER));
    ...
    public int calculateXpPerHour() {
        ...
        int currentXP = CupidBot.getClient().getSkillExperience(Skill.HUNTER);

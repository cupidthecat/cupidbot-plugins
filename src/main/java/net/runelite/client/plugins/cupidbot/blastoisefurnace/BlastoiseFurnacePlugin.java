...
import static net.runelite.client.plugins.cupidbot.blastoisefurnace.BlastoiseFurnaceScript.*;


@PluginDescriptor(
        name = "BlastoiseFurnace",
        description = "Storm's BlastoiseFurnace plugin",
        tags = {"cupidbot", "smithing", "bar", "ore", "blast", "furnace"},
        authors = {"Storm"},
        version = BlastoiseFurnacePlugin.version,
        minClientVersion = "2.1.0",
        enabledByDefault = PluginConstants.DEFAULT_ENABLED,
        isExternal = PluginConstants.IS_EXTERNAL,
        iconUrl = "BlastoiseFurnacePlugin/assets/icon.jpg",
        cardUrl = "BlastoiseFurnacePlugin/assets/card.jpg"
)
@Slf4j

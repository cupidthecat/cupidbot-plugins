package net.runelite.client.plugins.cupidbot.piebaker;
...
public class PieBakerPlugin extends Plugin {
    ...
    protected void startUp() {
        ...
        startMagicXP = CupidBot.getClient().getSkillExperience(Skill.MAGIC);
        startCookingXP = CupidBot.getClient().getSkillExperience(Skill.COOKING);
    }
    ...
    public int getMagicXPPerHour() {
        int currentXP = CupidBot.getClient().getSkillExperience(Skill.MAGIC);

package net.runelite.client.plugins.cupidbot.lunartablets;
...
@PluginDescriptor(
        ...
        iconUrl = "LunarTabletsPlugin/assets/icon.png", // URL to plugin icon shown in client (optional)
        cardUrl = "LunarTabletsPlugin/assets/card.png", // URL to plugin card image for website (optional)

package net.runelite.client.plugins.cupidbot.thieving.npc;

import net.runelite.api.events.ChatMessage;
import net.runelite.client.plugins.cupidbot.thieving.State;
import net.runelite.client.plugins.cupidbot.CupidBot;
import net.runelite.client.plugins.cupidbot.thieving.ThievingScript;
...
public class WealthyCitizenStrategy implements ThievingNpcStrategy {
    ...
    private Rs2NpcModel getDistractedTarget(ThievingScript script) {
        ...
        if (!isDistractedNpc(target)) {
            target = CupidBot.getRs2NpcCache().query()

...
import net.runelite.client.plugins.cupidbot.slayer.combat.SlayerDodgeScript;
import net.runelite.client.plugins.cupidbot.slayer.combat.SlayerFlickerScript;
import net.runelite.client.plugins.cupidbot.slayer.combat.SlayerHighAlchScript;
...
public class SlayerPlugin extends Plugin {
    ...
    public void onActorDeath(ActorDeath event) {
        try {
            ...
            CupidBot.showMessage("You died! Logged out to pause gravestone timer. Recover your items manually.");

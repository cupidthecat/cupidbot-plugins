...
import net.runelite.client.plugins.cupidbot.giantmole.enums.DefaultLooterStyle;
import net.runelite.client.plugins.cupidbot.giantmole.enums.GiantMoleState;
...
import static net.runelite.client.plugins.cupidbot.util.player.Rs2Player.isMember;
...
public class GiantMoleScript extends Script
{
    ...
    public boolean run(GiantMoleConfig config)
    {
        ...
        CupidBot.runEnergyThreshold = 5000;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() ->
        {
            try
            {
                ...
                if (!CupidBot.isPluginEnabled(BossTimersPlugin.class))
                {
                    Plugin bossingInfo = CupidBot.getPluginManager().getPlugins().stream()
                            .filter(x -> x.getClass().getName().equals(BossTimersPlugin.class.getName()))
                            .findFirst()
                            .orElse(null);
                    CupidBot.startPlugin(bossingInfo);
                }
    ...
    {
        return CupidBot.getRs2TileObjectCache().query().withId(ObjectID.MOLE_HILL).nearest();
    }
    ...
    public static WorldPoint getMoleLocation()
    {
        ...
        return CupidBot.getClientThread()
                .runOnClientThreadOptional(() -> CupidBot.getClient().getHintArrowPoint())
                .orElse(null);
    }
    ...
    {
        return CupidBot.getInfoBoxManager().getInfoBoxes().stream()
    ...
    {
        NPC hintNpc = CupidBot.getClientThread()
                .runOnClientThreadOptional(() -> CupidBot.getClient().getHintArrowNpc())
                .orElse(null);
    ...
    public void attackMole()
    {
        ...
        boolean moleIsDigging = CupidBot.getClientThread()
                .runOnClientThreadOptional(() ->
                {
                    NPC hintNpc = CupidBot.getClient().getHintArrowNpc();
    ...
    public void handlePrayer(GiantMoleConfig config)
    {
        ...
        boolean underAttack = CupidBot.getRs2NpcCache().query().where(Rs2NpcModel::isInteractingWithPlayer).count() > 0 || Rs2Combat.inCombat();
    ...
    {
        boolean usingQoLFood = CupidBot.getConfigManager().getConfiguration("QoL", "autoEatFood", Boolean.class);
    ...
    public boolean needBanking(GiantMoleConfig config)
    {
        ...
        if (Rs2Inventory.isFull())
        {
            ...
            CupidBot.log("Inventory is full, banking...");
            return true;
        }

...
import net.runelite.client.plugins.cupidbot.CalcifiedRockMiner.CalcifiedRockMinerOverlay;
import net.runelite.client.plugins.cupidbot.CalcifiedRockMiner.CalcifiedRockMinerScript;
import net.runelite.client.plugins.cupidbot.util.misc.TimeUtils;
...
@PluginDescriptor(
        ...
        tags = {"prayer", "rock", "calcified", "taf", "cupidbot"},
...
public class CalcifiedRockMinerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.cupidbot.CalcifiedRockMiner.CalcifiedRockMinerConfig config;
    @Inject
    ...
    @Provides
    net.runelite.client.plugins.cupidbot.CalcifiedRockMiner.CalcifiedRockMinerConfig provideConfig(ConfigManager configManager) {

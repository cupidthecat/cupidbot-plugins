...
@ConfigInformation("<h2>Auto Firemaking Plus</h2>" +
        ...
        "<p>6. <strong>Speed mode:</strong> disables CupidBot antiban. Throwaway accounts only.</p>")
public interface AutoFiremakingPlusConfig extends Config {
    ...
    @ConfigItem(
            ...
            description = "Disables CupidBot's antiban. Faster, more pattern-detectable. Throwaway only.",
            position = 9,
            section = generalSection
    )

package net.runelite.client.plugins.cupidbot.gebotrecruiter;
...
public class RecruiterScript extends Script {
                ...
                if (config.recruit()) {
                    ...
                    for (Rs2PlayerModel player : localPlayers) {
                        ...
                        if (menuAction != null) {
                            ...
                            // Set this menu entry as the target menu in CupidBot
                            CupidBot.targetMenu = recruitMenuEntry;

                            // Invoke the "Recruit" action programmatically
                            CupidBot.doInvoke(recruitMenuEntry, player.getCanvasTilePoly().getBounds());
    ...
    private void moveMouseToPlayer(Player player) {
        ...
        if (playerBounds != null) {
            ...
            if (randomPoint != null) {
                ...
                CupidBot.getMouse().move(randomPoint.getX(), randomPoint.getY());
    ...
    private MenuAction findRecruitAction() {
        MenuEntry[] menuEntries = CupidBot.getClient().getMenuEntries();

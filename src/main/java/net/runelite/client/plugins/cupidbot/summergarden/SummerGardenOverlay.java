...
import  net.runelite.client.plugins.cupidbot.summergarden.ShowNumbers;
import  net.runelite.client.plugins.cupidbot.summergarden.SummerGardenConfig;
import  net.runelite.client.plugins.cupidbot.summergarden.SummerGardenPlugin;
...
public class SummerGardenOverlay extends Overlay
{
    ...
    private final  net.runelite.client.plugins.cupidbot.summergarden.SummerGardenConfig config;

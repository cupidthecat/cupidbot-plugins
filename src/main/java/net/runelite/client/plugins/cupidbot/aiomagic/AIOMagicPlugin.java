package net.runelite.client.plugins.cupidbot.aiomagic;
...
import net.runelite.client.plugins.cupidbot.aiomagic.AIOMagicConfig;
import net.runelite.client.plugins.cupidbot.aiomagic.AIOMagicOverlay;
import net.runelite.client.plugins.cupidbot.aiomagic.enums.StunSpell;
import net.runelite.client.plugins.cupidbot.aiomagic.enums.SuperHeatItem;
import net.runelite.client.plugins.cupidbot.aiomagic.enums.TeleportSpell;
import net.runelite.client.plugins.cupidbot.aiomagic.scripts.*;
...
@PluginDescriptor(
        ...
        description = "CupidBot Magic plugin",
        tags = {"magic", "cupidbot", "skilling", "training"},
        version = AIOMagicPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "AIOMagicPlugin/assets/card.png",
        iconUrl = "AIOMagicPlugin/assets/icon.png",

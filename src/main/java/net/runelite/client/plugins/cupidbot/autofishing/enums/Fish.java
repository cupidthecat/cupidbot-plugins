package net.runelite.client.plugins.cupidbot.autofishing.enums;
...
public enum Fish {
    ...
    KARAMBWANJI("Karambwanji", List.of("Raw karambwanji"), FishingMethod.KARAMBWANJI_NET, FishingSpot.KARAMBWANJI.getIds()),

...
import net.runelite.client.plugins.cupidbot.giantsfoundry.enums.Heat;
...
import static net.runelite.client.plugins.cupidbot.giantsfoundry.enums.Stage.*;
...
public class GiantsFoundryState {
    ...
    public static int getHeatAmount() {
        return CupidBot.getVarbitValue(VARBIT_HEAT);
    }

    public static int getProgressAmount() {
        return CupidBot.getVarbitValue(VARBIT_PROGRESS);
    }
    ...
    public static Rs2TileObjectModel getStageObject(Stage stage) {
        switch (stage) {
            case TRIP_HAMMER:
                return CupidBot.getRs2TileObjectCache().query().withName("trip hammer").nearestOnClientThread();
            case GRINDSTONE:
                return CupidBot.getRs2TileObjectCache().query().withName("grindstone").nearestOnClientThread();
            case POLISHING_WHEEL:
                return CupidBot.getRs2TileObjectCache().query().withName("polishing wheel").nearestOnClientThread();
        }
        return null;
    }
    ...
    {
        return CupidBot.getClient().getVarpValue(173) == 1;
    }

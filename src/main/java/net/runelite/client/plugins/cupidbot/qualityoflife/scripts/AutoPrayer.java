...
import net.runelite.client.plugins.cupidbot.qualityoflife.enums.WeaponAnimation;
import net.runelite.client.plugins.cupidbot.qualityoflife.enums.WeaponID;
...
public class AutoPrayer extends Script {
    ...
    private static int getOffensivePrayerSkillLevel() {
        ...
        return CupidBot.getClient().getRealSkillLevel(Skill.PRAYER);
    }
    ...
    private static boolean isLastManStandingWorld() {
        ...
        return CupidBot.getClient().getWorldType().contains(WorldType.LAST_MAN_STANDING);
    }

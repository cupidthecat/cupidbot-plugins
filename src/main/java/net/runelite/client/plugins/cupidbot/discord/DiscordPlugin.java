package net.runelite.client.plugins.cupidbot.discord;
...
@PluginDescriptor(
        ...
        cardUrl = "DiscordPlugin/assets/card.jpg",
        iconUrl = "DiscordPlugin/assets/icon.jpg",
...
public class DiscordPlugin extends Plugin {
    ...
    protected void startUp() {
        ...
        BufferedImage icon = loadToolbarIcon();
    ...
    private BufferedImage loadToolbarIcon() {
        ...
        try {
            ...
            graphics.fillRoundRect(2, 2, 20, 20, 6, 6);
            graphics.setColor(Color.WHITE);
            graphics.fillOval(7, 9, 3, 3);
            graphics.fillOval(14, 9, 3, 3);
            graphics.drawArc(7, 9, 10, 7, 200, 140);
        } finally {
            graphics.dispose();
        }
        return fallback;

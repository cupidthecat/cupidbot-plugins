package net.runelite.client.plugins.cupidbot.sailing;
...
import net.runelite.client.plugins.cupidbot.sailing.features.salvaging.SalvagingHighlight;
import net.runelite.client.plugins.cupidbot.sailing.features.salvaging.SalvagingScript;
import net.runelite.client.plugins.cupidbot.sailing.features.trials.TrialsScript;
import net.runelite.client.plugins.cupidbot.sailing.features.trials.debug.BoatPathOverlay;
import net.runelite.client.plugins.cupidbot.sailing.features.trials.overlay.TrialRouteOverlay;
...
@PluginDescriptor(
	...
	description = "CupidBot Sailing Plugin",
	tags = {"sailing"},
	authors = { "Mocrosoft" },
    ...
    cardUrl = "MSailingPlugin/assets/card.jpg",
    iconUrl = "MSailingPlugin/assets/icon.jpg"
)
@Slf4j

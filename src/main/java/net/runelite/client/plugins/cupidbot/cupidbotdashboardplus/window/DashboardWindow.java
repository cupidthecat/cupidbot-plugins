package net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.window;

import lombok.extern.slf4j.Slf4j;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.CupidBotDashboardPlusConfig;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.data.PollSnapshot;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.AntibanStatePanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.DashboardSection;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.EventLogPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.GuidePanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.InventoryPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.NearbyNpcsPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.PlayerPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.ScriptsPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.SkillsPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.panels.XpChartPanel;
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.poller.GameStatePoller;
...
public class DashboardWindow extends JFrame {
    ...
    private final CupidBotDashboardPlusConfig config;
    ...
    private static final String CONFIG_GROUP = "CupidBotDashboardPlus";
    ...
    public DashboardWindow(GameStatePoller poller, CupidBotDashboardPlusConfig config) {
        super("CupidBot Dashboard Plus");
        this.poller = poller;
        this.config = config;
    ...
    private static Integer readInt(String key) {
        try {
            String raw = CupidBot.getConfigManager().getConfiguration(CONFIG_GROUP, key);
    ...
    private static void writeInt(String key, int value) {
        try {
            CupidBot.getConfigManager().setConfiguration(CONFIG_GROUP, key, Integer.toString(value));
    ...
    private JPanel buildHeader() {
        ...
        JLabel title = new JLabel("CupidBot Dashboard Plus");
    ...
    private JPanel buildFooter() {
        ...
        JLabel info = new JLabel("v" + net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.CupidBotDashboardPlusPlugin.version);

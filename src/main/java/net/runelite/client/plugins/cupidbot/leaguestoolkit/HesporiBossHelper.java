package net.runelite.client.plugins.cupidbot.leaguestoolkit;
...
public class HesporiBossHelper {
    ...
    public void tick() {
        ...
        int anim = CupidBot.getClientThread().runOnClientThreadOptional(
    ...
    private void handleFlowerPhase() {
        ...
        HeadIcon flowerPrayer = CupidBot.getClientThread().runOnClientThreadOptional(
                () -> flower.getHeadIcon()
        ).orElse(null);
    ...
    public boolean handleVineDodge() {
        ...
        LocalPoint myLocal = CupidBot.getClientThread().runOnClientThreadOptional(() -> {
    ...
    private Rs2NpcModel findActiveFlower() {
        ...
        return CupidBot.getRs2NpcCache().query()
                ...
                .where(npc -> {
                    ...
                    HeadIcon icon = CupidBot.getClientThread().runOnClientThreadOptional(
                            () -> npc.getHeadIcon()
                    ).orElse(null);
    ...
    public void tickCombat() {
        ...
        boolean alreadyFighting = CupidBot.getClientThread().runOnClientThreadOptional(() -> {
            var player = CupidBot.getClient().getLocalPlayer();
        ...
        if (!alreadyFighting) {
            ...
            CupidBot.getClientThread().invoke(() -> {
                try {
                    ...
                    var comp = CupidBot.getClient().getNpcDefinition(rawNpc.getId());
                    if (comp != null) {

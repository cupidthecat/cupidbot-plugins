...
import net.runelite.client.plugins.cupidbot.bradleycombat.actions.*;
import net.runelite.client.plugins.cupidbot.bradleycombat.handlers.MenuHandler;
import net.runelite.client.plugins.cupidbot.bradleycombat.handlers.PostActionHandler;
import net.runelite.client.plugins.cupidbot.bradleycombat.handlers.RelayHandler;
import net.runelite.client.plugins.cupidbot.bradleycombat.handlers.TankHandler;
...
import static net.runelite.client.plugins.cupidbot.CupidBot.isLoggedIn;
...
@PluginDescriptor(
        ...
        tags = {"combat", "hotkeys", "cupidbot"},
        authors = {"Bradley"},
        version = BradleyCombatPlugin.version,
        minClientVersion = "2.0.7",
        enabledByDefault = PluginConstants.DEFAULT_ENABLED,
        isExternal = PluginConstants.IS_EXTERNAL,
        iconUrl = "BradleyCombatPlugin/assets/icon.jpg",
        cardUrl = "BradleyCombatPlugin/assets/card.jpg"
)

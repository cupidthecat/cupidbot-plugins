...
import  net.runelite.client.plugins.cupidbot.summergarden.SummerGardenOverlay;
import  net.runelite.client.plugins.cupidbot.summergarden.SummerGardenScript;
...
@PluginDescriptor(
        ...
        description = " CupidBot Summers Garden (V2.1)",
        tags = {"Summers Garden", "minigame", "thieving", "cupidbot", "skilling", "summer", "summers", "garden", "sq'irk", "juice"},
...
public class SummerGardenPlugin extends Plugin
{
    ...
    @Inject
    public  net.runelite.client.plugins.cupidbot.summergarden.SummerGardenConfig config;
    ...
    @Provides
     net.runelite.client.plugins.cupidbot.summergarden.SummerGardenConfig provideConfig(ConfigManager configManager)
    {

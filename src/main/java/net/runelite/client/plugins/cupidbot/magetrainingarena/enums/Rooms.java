package net.runelite.client.plugins.cupidbot.magetrainingarena.enums;
...
import static net.runelite.client.plugins.cupidbot.magetrainingarena.MageTrainingArenaScript.tryEquipBestStaffAndCast;
...
public enum Rooms {
    TELEKINETIC("Telekinetic", 23673, null, null, Points.TELEKINETIC,
            () -> {
                ...
                CupidBot.log("TELEKINETIC req met: " + result, Level.DEBUG);
                return result;
            }),
    ...
    ALCHEMIST("Alchemist", 23675,
            ...
            () -> {
                ...
                CupidBot.log("ALCHEMIST req met: HIGH=" + high + " LOW=" + low, Level.DEBUG);
                return high || low;
            }),
    ...
    ENCHANTMENT("Enchantment", 23674,
            ...
            Points.ENCHANTMENT,
            () -> {
                int level = CupidBot.getClient().getBoostedSkillLevel(Skill.MAGIC);
                boolean result;
                ...
                CupidBot.log("ENCHANTMENT req met (level=" + level + "): " + result, Level.DEBUG);
                return result;
            }),
    ...
    GRAVEYARD("Graveyard", 23676,
            ...
            () -> {
                ...
                CupidBot.log("GRAVEYARD req met: BANANAS=" + bananas + " PEACHES=" + peaches, Level.DEBUG);
                if (!bananas && !peaches) {
                    CupidBot.log("Missing requirement to cast Bones to Bananas or Peaches.", Level.DEBUG);
                    return false;
                }
                return true;
            });

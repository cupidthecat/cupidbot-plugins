package net.runelite.client.plugins.cupidbot.autoessencemining;
...
import net.runelite.client.plugins.cupidbot.autoessencemining.enums.AutoEssenceMiningState;
...
public class AutoEssenceMiningScript extends Script {
    ...
    private void handleWalkingToAubury() {
        ...
        CupidBot.status = "Walking to Aubury";
    ...
    private void handleTeleportingWithAubury() {
        ...
        CupidBot.status = "Teleporting with Aubury";
        ...
        // find Aubury NPC
        Rs2NpcModel aubury = CupidBot.getRs2NpcCache().query().withName("Aubury").nearestOnClientThread();
        if (aubury != null) {
    ...
    private void handleMiningEssence() {
        ...
        CupidBot.status = "Mining essence";
        ...
        var essenceRock = CupidBot.getRs2TileObjectCache().query().withName("Rune Essence").nearestOnClientThread();
    ...
    private void handleUsingPortal() {
        ...
        CupidBot.status = "Using portal to exit";
        ...
        var portal = CupidBot.getRs2TileObjectCache().query().withName("Portal").nearestOnClientThread();
    ...
    private void handleBanking() {
        ...
        CupidBot.status = "Banking at Varrock East";

...
import static net.runelite.client.plugins.cupidbot.pyrefox.enums.PyreFoxState.*;
...
public class PyreFoxStateManager extends Script
{
	...
	{
//		CupidBot.log(Rs2Player.distanceTo(PyreFoxConstants.PYRE_FOX_CENTER_POINT) + "");
		...
		var trap = trapPoint != null ? CupidBot.getRs2TileObjectCache().query().within(PyreFoxConstants.TRAP_OBJECT_POINT, 0).first() : null;

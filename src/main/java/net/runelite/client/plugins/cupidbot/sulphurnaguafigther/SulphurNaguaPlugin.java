package net.runelite.client.plugins.cupidbot.sulphurnaguafigther; // Passen Sie den Paketnamen an
...
@PluginDescriptor(
        ...
        tags = {"combat", "pvm", "nagua", "varlamore", "cupidbot"},
        authors = { "VIP" },
        version = SulphurNaguaPlugin.version,
        minClientVersion = "1.9.8",
        cardUrl = "SulphurNaguaPlugin/assets/card.png",
        iconUrl = "SulphurNaguaPlugin/assets/icon.png",
...
public class SulphurNaguaPlugin extends Plugin {
    ...
    public long getXpGained() {
        ...
        return CupidBot.getClient().getOverallExperience() - scriptStartExp;
    }

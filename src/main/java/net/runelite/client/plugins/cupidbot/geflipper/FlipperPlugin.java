package net.runelite.client.plugins.cupidbot.geflipper;
...
@PluginDescriptor(
        ...
        cardUrl = "FlipperPlugin/assets/card.jpg",
        iconUrl = "FlipperPlugin/assets/icon.jpg",
...
public class FlipperPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.cupidbot.geflipper.FlipperConfig config;

    @Provides
    net.runelite.client.plugins.cupidbot.geflipper.FlipperConfig provideConfig(ConfigManager configManager) {

...
@PluginDescriptor(
        ...
        iconUrl = "revKillerPlugin/assets/icon.png", // URL to plugin icon shown in client (optional)
        cardUrl = "revKillerPlugin/assets/card.png", // URL to plugin card image for website (optional)
...
public class revKillerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.cupidbot.revkiller.revKillerConfig config;
    @Provides
    net.runelite.client.plugins.cupidbot.revkiller.revKillerConfig provideConfig(ConfigManager configManager) {
    ...
    @Inject
    private net.runelite.client.plugins.cupidbot.revkiller.revKillerOverlay revKillerOverlay;

    @Inject
    net.runelite.client.plugins.cupidbot.revkiller.revKillerScript revKillerScript;

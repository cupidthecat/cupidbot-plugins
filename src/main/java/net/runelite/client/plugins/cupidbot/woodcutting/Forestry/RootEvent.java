...
public class RootEvent implements BlockingEvent {
    ...
    public boolean execute() {
        CupidBot.log("RootEvent: Executing Root event");
        ...
        while (this.validate()) {
            ...
            if (specialRoot != null) {
                ...
                if (Rs2Player.isInteracting() && Rs2Player.getInteracting() != null) {
                    Actor interactingNpc = CupidBot.getClient().getLocalPlayer().getInteracting();
                    if (interactingNpc.getWorldLocation().equals(specialRoot.getWorldLocation())) {
                        continue;
                    }
                }
                // Interact with the special root
                CupidBot.log("RootEvent: Interacting with special root at " + specialRoot.getWorldLocation());
            ...
            // If regular root is present
                ...
                CupidBot.log("RootEvent: Interacting with regular root at " + root.getWorldLocation());

...
public class HivesEvent implements BlockingEvent {
    ...
    public boolean validate() {
        try{
            ...
            var beehives = CupidBot.getRs2NpcCache().query()
    ...
    public boolean execute() {
        ...
        while (this.validate()) {
            ...
            List<Rs2NpcModel> availableBeehives = CupidBot.getRs2NpcCache().query()
            ...
            if (CupidBot.getRs2NpcCache().query().where(x -> x.getIndex() == targetBeehive.getIndex()).count() == 0) {

package net.runelite.client.plugins.cupidbot.barbarianvillagefisher;
...
import net.runelite.client.plugins.cupidbot.barbarianvillagefisher.enums.BarbarianFishingFunctions;
import net.runelite.client.plugins.cupidbot.barbarianvillagefisher.enums.BarbarianFishingType;
...
public class BarbarianVillageFisherScript extends Script {
        ...
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem(rodName)) {
                ...
                if (!Rs2Inventory.hasItem(rodName)) {
                    ...
                    CupidBot.showMessage("Could not find fishing rod in bank.");
                    shutdown();
                }
            ...
            if (!Rs2Inventory.hasItem(baitName)) {
                ...
                if (!Rs2Inventory.hasItem(baitName)) {
                    ...
                    CupidBot.showMessage("Could not find bait in bank.");
                    shutdown();
                }
            }
        }
    ...
    private boolean isGameObjectOnTile(WorldPoint location, int id) {
        var result = CupidBot.getRs2TileObjectCache().query()
                .withId(id)
                .within(location, 0)
                .first();
        return result != null;

...
@PluginDescriptor(
        ...
        tags = {"Tempoross", "minigame", "s1d", "see1duck", "cupidbot", "fishing", "skilling"},
...
public class TemporossPlugin extends Plugin {
    ...
    public void onGameTick(GameTick e) {
        ...
        Rs2NpcModel doubleFishingSpot = CupidBot.getRs2NpcCache().query().withId(NpcID.FISHING_SPOT_10569).nearest();
    ...
    public static void setHarpoonType(HarpoonType harpoonType) {
        CupidBot.getConfigManager().setConfiguration("cupidbot-tempoross", "harpoonType", harpoonType);
    }

    // Set rope config
    public static void setRope(boolean rope) {
        CupidBot.getConfigManager().setConfiguration("cupidbot-tempoross", "rope", rope);
    }
}

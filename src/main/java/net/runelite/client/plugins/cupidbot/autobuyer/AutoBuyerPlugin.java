...
@PluginDescriptor(
        ...
        cardUrl = "AutoBuyerPlugin/assets/card.png",
        iconUrl = "AutoBuyerPlugin/assets/icon.png",
...
public class AutoBuyerPlugin extends Plugin {
    ...
    @Inject
    private net.runelite.client.plugins.cupidbot.autobuyer.AutoBuyerConfig config;

    @Provides
    net.runelite.client.plugins.cupidbot.autobuyer.AutoBuyerConfig provideConfig(ConfigManager configManager) {

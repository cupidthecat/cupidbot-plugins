...
import net.runelite.client.plugins.cupidbot.giantsfoundry.enums.Mould;
...
public class MouldHelper {
    ...
    public static void selectBest()
    {
        ...
        CommissionType type1 = CommissionType.forVarbit(CupidBot.getVarbitValue(SWORD_TYPE_1_VARBIT));
        CommissionType type2 = CommissionType.forVarbit(CupidBot.getVarbitValue(SWORD_TYPE_2_VARBIT));
        ...
        {
            if (bestWidget != null) {
                    CupidBot.doInvoke(new NewMenuEntry(bestWidget.getIndex(), MOULD_LIST_PARENT, MenuAction.CC_OP.getId(), 1, -1, "Select"),

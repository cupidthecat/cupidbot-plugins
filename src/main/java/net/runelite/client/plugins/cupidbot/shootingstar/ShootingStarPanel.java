...
import net.runelite.client.plugins.cupidbot.shootingstar.model.ShootingStarTableHeader;
import net.runelite.client.plugins.cupidbot.shootingstar.model.ShootingStarTableRow;
...
public class ShootingStarPanel extends PluginPanel
{
	...
	private JPopupMenu buildPopupMenu(ShootingStarTableRow row, Star star)
	{
		...
		hopEntryOption.addActionListener(e -> CupidBot.hopToWorld(star.getWorld()));

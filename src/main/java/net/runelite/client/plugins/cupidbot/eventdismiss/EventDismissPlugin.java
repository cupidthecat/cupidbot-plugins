...
@PluginDescriptor(
        ...
        tags = {"random", "events", "cupidbot", "lamp", "genie"},
        authors = {"Unknown"},
        version = EventDismissPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "EventDismissPlugin/assets/card.jpg",
        iconUrl = "EventDismissPlugin/assets/icon.jpg",
...
public class EventDismissPlugin extends Plugin {
    ...
    protected void startUp() throws AWTException {
        ...
        CupidBot.getBlockingEventManager().add(dismissNpcEvent);
        CupidBot.getBlockingEventManager().add(useLampEvent);
    ...
    protected void shutDown() {
        CupidBot.getBlockingEventManager().remove(dismissNpcEvent);
        CupidBot.getBlockingEventManager().remove(useLampEvent);
        if (overlayManager != null) {

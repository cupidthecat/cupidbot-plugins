...
/**
 * Configuration for the CupidBotDashboardPlus plugin.
 *
 * <p>Sections:
 * <ul>
 ...
 * </ul>
 */
@ConfigGroup("CupidBotDashboardPlus")
@ConfigInformation(
    "<h2>CupidBot Dashboard Plus</h2>" +
    "<h3>Version: " + CupidBotDashboardPlusPlugin.version + "</h3>" +
...
public interface CupidBotDashboardPlusConfig extends Config {

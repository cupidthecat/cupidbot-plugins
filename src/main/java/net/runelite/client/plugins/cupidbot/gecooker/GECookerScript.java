package net.runelite.client.plugins.cupidbot.gecooker;
...
import net.runelite.client.plugins.cupidbot.gecooker.enums.CookingItem;
import net.runelite.client.plugins.cupidbot.gecooker.enums.GEWorkLocation;
import net.runelite.client.plugins.cupidbot.gecooker.enums.LogType;
    ...
    private void bank(CookingItem cookingItem) {
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem(cookingItem.getRawItemID())) {
                ...
                CupidBot.showMessage("Could not find cooking item in bank.");
                shutdown();
            }
            sleep(180, 540);
            Rs2Bank.closeBank();
    ...
    private void bankForFireSupplies(LogType logType) {
        if (Rs2Bank.openBank()) {
            ...
            if (!Rs2Inventory.hasItem("Tinderbox")) {
                ...
                CupidBot.showMessage("Could not find Tinderbox in bank.");
                shutdown();
            }
            ...
            if (!Rs2Inventory.hasItem(logType.getLogID())) {
                ...
                CupidBot.showMessage("Could not find logs in bank.");
                shutdown();
            }
            sleep(180, 540);
            Rs2Bank.closeBank();

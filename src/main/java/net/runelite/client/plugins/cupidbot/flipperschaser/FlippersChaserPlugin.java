package net.runelite.client.plugins.cupidbot.flipperschaser;
...
@PluginDescriptor(
        ...
        tags = {"service", "automation", "combat", "cupidbot"},
        authors = {"Bttqjs"},
        version = FlippersChaserPlugin.version,
        minClientVersion = "2.0.7",
        cardUrl = "FlippersChaserPlugin/assets/card.jpg",
        iconUrl = "FlippersChaserPlugin/assets/icon.jpg",
...
public class FlippersChaserPlugin extends Plugin {
    ...
    public void onNpcSpawned(NpcSpawned event) {
        ...
        if (npc.getName().equals("Mogre")) {
            inCombat = true;
            var rs2Npc = CupidBot.getRs2NpcCache().query().where(n -> n.getNpc().equals(npc)).nearest();
    ...
    private Rs2NpcModel findFishingSpot() {
        return CupidBot.getRs2NpcCache().query().withName("Ominous Fishing Spot").nearestOnClientThread();
    }

...
@PluginDescriptor(
    ...
    iconUrl = "WildernessAgilityPlugin/assets/icon.png",
    cardUrl = "httpa://chsami.github.io/CupidBot-Hub/WildernessAgilityPlugin/assets/card.png"
)
public class WildernessAgilityPlugin extends Plugin {
    ...
    protected void startUp() throws Exception {
        CupidBot.log("WildernessAgilityPlugin: startUp called");
    ...
    protected void shutDown() throws Exception {
        CupidBot.log("WildernessAgilityPlugin: shutDown called");
        if (script != null) {
            script.shutdown();
        }
        if (overlayManager != null) {
    ...
    public void onChatMessage(ChatMessage chatMessage) {
        ...
        if (chatMessage.getType() == ChatMessageType.GAMEMESSAGE && cleanMsg.equals("Oh dear, you are dead!")) {
            CupidBot.log("[WildernessAgility] Death detected via chat message");

package net.runelite.client.plugins.cupidbot.cupidbotdashboardplus;
...
import net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.window.DashboardWindow;
...
/**
 * CupidBotDashboardPlus is part of the CupidBot Plus suite.
 *
 ...
 * Game state is read in-process via {@link CupidBot#getClient()} and the Rs2
 ...
 */
@PluginDescriptor(
        name = "<html>[<font color=#BB86FC>P</font>] " + "CupidBot Dashboard Plus",
        description = "Native Swing monitoring dashboard for your CupidBot session. Floating window plus a compact sidebar panel. No HTTP, no Agent Server dependency.",
        tags = {"dashboard", "monitoring", "cupidbot", "plus"},
        authors = {"pjmarz"},
        version = CupidBotDashboardPlusPlugin.version,
        minClientVersion = "2.0.13",
        cardUrl = "CupidBotDashboardPlusPlugin/assets/card.png",
        iconUrl = "CupidBotDashboardPlusPlugin/assets/icon.png",
        enabledByDefault = PluginConstants.DEFAULT_ENABLED,
        isExternal = PluginConstants.IS_EXTERNAL
)
@Slf4j
public class CupidBotDashboardPlusPlugin extends Plugin {

    public static final String version = "1.2.1";

    @Inject
    private CupidBotDashboardPlusConfig config;
    ...
    @Provides
    CupidBotDashboardPlusConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(CupidBotDashboardPlusConfig.class);
    }
    ...
    protected void startUp() throws AWTException {
        ...
        navButton = NavigationButton.builder()
                .tooltip("CupidBot Dashboard Plus")
        ...
        CupidBot.log("CupidBotDashboardPlus v" + version + " started (native Swing mode)");
    }
    ...
    protected void shutDown() {
        ...
        alertManager = null;
        CupidBot.log("CupidBotDashboardPlus v" + version + " stopped");
    }
    ...
    public void onChatMessage(ChatMessage event) {
        ...
        CupidBot.log("CupidBotDashboardPlus: " + text);
    }

    @Subscribe
    public void onConfigChanged(ConfigChanged event) {
        if (!"CupidBotDashboardPlus".equals(event.getGroup())) return;

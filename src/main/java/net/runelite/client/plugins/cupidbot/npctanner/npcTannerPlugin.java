...
@PluginDescriptor(
        ...
        iconUrl = "npcTannerPlugin/assets/icon.png", // URL to plugin icon shown in client (optional)
        cardUrl = "npcTannerPlugin/assets/card.png", // URL to plugin card image for website (optional)

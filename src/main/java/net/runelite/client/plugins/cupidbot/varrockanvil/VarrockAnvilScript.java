package net.runelite.client.plugins.cupidbot.varrockanvil;
...
import net.runelite.client.plugins.cupidbot.varrockanvil.enums.AnvilItem;
import net.runelite.client.plugins.cupidbot.varrockanvil.enums.Bars;
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            switch (state) {
                case SMITHING:
                    ...
                    if (CupidBot.getRs2TileObjectCache().query().withId(2097).interact()) {
                        debug("Using anvil");
                        ...
                        if (Rs2Widget.getWidget(AnvilContainerWidgetID, 1) != null) {
                            if (CupidBot.getVarbitPlayerValue(AnvilMakeVarbitPlayer) < Rs2Inventory.count(barType.getId())) {

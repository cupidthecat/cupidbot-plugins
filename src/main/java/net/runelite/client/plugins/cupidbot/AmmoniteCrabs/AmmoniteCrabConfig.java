...
import net.runelite.client.plugins.cupidbot.AmmoniteCrabs.enums.AmmoniteCrabLocations;
import net.runelite.client.plugins.cupidbot.AmmoniteCrabs.enums.OffensivePotions;

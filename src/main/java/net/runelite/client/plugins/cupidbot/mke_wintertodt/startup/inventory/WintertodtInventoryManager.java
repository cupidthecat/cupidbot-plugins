package net.runelite.client.plugins.cupidbot.mke_wintertodt.startup.inventory;
...
public class WintertodtInventoryManager {
    ...
    public boolean setupInventory() {
        try {
            CupidBot.log("Setting up Wintertodt inventory...");
            ...
            if (!Rs2Bank.isOpen()) {
                ...
                if (!Rs2Bank.openBank()) {
                    CupidBot.log("Failed to open bank for inventory setup");
                    return false;
                }
            }
            ...
            CupidBot.log("Error setting up inventory: " + e.getMessage());
            return false;
        }
    }
    ...
    private void moveItemToSlot(int itemId, int targetSlot, String description) {
        try {
            ...
            CupidBot.log("Error moving item " + itemId + " to slot " + targetSlot + ": " + e.getMessage());
        }
    }
    ...
    private void logInventorySetup() {
        ...
        if (tinderboxItem != null && tinderboxItem.getSlot() == TINDERBOX_SLOT) {
            CupidBot.log("  Slot 25: Tinderbox ✓");
        }
        ...
        for (int axeId : AXE_PRIORITY) {
            ...
            if (axeItem != null && axeItem.getSlot() == AXE_SLOT) {
                CupidBot.log("  Slot 24: " + getAxeName(axeId) + " ✓");
                break;
            }
        }

        CupidBot.log("Left side free for logs, kindling and food");
    }
    ...
    public void reset() {
        ...
        CupidBot.log("Inventory manager state reset - ready for fresh setup");
    }

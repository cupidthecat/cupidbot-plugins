package net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.data;
 ...
 *
 * <p>Produced by {@link net.runelite.client.plugins.cupidbot.cupidbotdashboardplus.poller.GameStatePoller}
...
public class PollSnapshot {
    ...
    public static class AntibanState {
        ...
        /** True when every script is globally paused (CupidBot.pauseAllScripts). */

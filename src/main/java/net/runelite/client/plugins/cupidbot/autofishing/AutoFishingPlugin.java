...
@PluginDescriptor(
        ...
        iconUrl = "AutoFishingPlugin/assets/icon.png",
        cardUrl = "AutoFishingPlugin/assets/card.png",
...
public class AutoFishingPlugin extends Plugin {
    ...
    protected void startUp() throws AWTException {
        ...
        startXp = CupidBot.getClient().getSkillExperience(Skill.FISHING);
    ...
    public int getXpGained() {
        return CupidBot.getClient().getSkillExperience(Skill.FISHING) - startXp;
    }

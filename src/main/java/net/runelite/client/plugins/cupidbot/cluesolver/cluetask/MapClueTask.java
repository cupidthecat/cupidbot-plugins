...
public class MapClueTask extends ClueTask {
    ...
    private boolean interactWithObject() {
        ...
        boolean interactionSuccessful = CupidBot.getRs2TileObjectCache().query().interact(objectId, "Search")
                || CupidBot.getRs2TileObjectCache().query().interact(objectId, "Investigate")
                || CupidBot.getRs2TileObjectCache().query().interact(objectId, "Examine")
                || CupidBot.getRs2TileObjectCache().query().interact(objectId, "Look-at")
                || CupidBot.getRs2TileObjectCache().query().interact(objectId, "Open");

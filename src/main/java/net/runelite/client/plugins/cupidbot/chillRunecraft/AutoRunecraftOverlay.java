...
import net.runelite.client.plugins.cupidbot.chillRunecraft.AutoRunecraftPlugin;
...
import static net.runelite.client.plugins.cupidbot.chillRunecraft.AutoRunecraftScript.*;

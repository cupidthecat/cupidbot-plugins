package net.runelite.client.plugins.cupidbot.blessedwine;
...
public class BlessedWineScript extends Script {
    ...
    public boolean run() {
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            ...
            if (!super.run()) return;
            int maxPrayerLevel = CupidBot.getClient().getRealSkillLevel(Skill.PRAYER);
            ...
            switch (state) {
                ...
                case BLESS_AT_ALTAR:
                    ...
                    CupidBot.getRs2TileObjectCache().query().interact(52799, "Bless");
                ...
                case USE_LIBATION_BOWL:
                    ...
                    CupidBot.getRs2TileObjectCache().query().interact(53018, "Fill");
                ...
                case RESTORE_PRAYER:
                    ...
                    CupidBot.getRs2TileObjectCache().query().interact(52405, "Bask");
    ...
    private int getCurrentXp() {
        return CupidBot.getClient().getSkillExperience(Skill.PRAYER);
    }

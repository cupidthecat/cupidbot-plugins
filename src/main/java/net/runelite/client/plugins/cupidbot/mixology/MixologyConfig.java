...
import net.runelite.client.plugins.cupidbot.mixology.enums.AgaHerbs;
import net.runelite.client.plugins.cupidbot.mixology.enums.LyeHerbs;
import net.runelite.client.plugins.cupidbot.mixology.enums.MoxHerbs;

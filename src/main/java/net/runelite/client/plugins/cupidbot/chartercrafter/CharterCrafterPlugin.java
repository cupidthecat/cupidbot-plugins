...
@PluginDescriptor(
        ...
        iconUrl = "CharterCrafterPlugin/assets/icon.png",
        cardUrl = "CharterCrafterPlugin/assets/card.png",
...
public class CharterCrafterPlugin extends Plugin {
    ...
    protected void startUp() throws AWTException {
        ...
        if (CupidBot.getClient() != null) {
            ...
            startCraftingXp = CupidBot.getClient().getSkillExperience(Skill.CRAFTING);
        } else {
            startMagicXp = 0;
            startCraftingXp = 0;
        }

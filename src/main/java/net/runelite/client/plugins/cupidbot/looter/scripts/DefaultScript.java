package net.runelite.client.plugins.cupidbot.looter.scripts;

import net.runelite.api.GameState;
import net.runelite.client.plugins.cupidbot.CupidBot;
import net.runelite.client.plugins.cupidbot.Script;
import net.runelite.client.plugins.cupidbot.looter.AutoLooterConfig;
import net.runelite.client.plugins.cupidbot.looter.enums.DefaultLooterStyle;
import net.runelite.client.plugins.cupidbot.looter.enums.LooterState;
...
public class DefaultScript extends Script {
    ...
    public boolean run(AutoLooterConfig config) {
        ...
        mainScheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                if (!super.run()) return;
                if (!CupidBot.isLoggedIn() || Rs2Combat.inCombat()) return;
                    ...
                    case LOOTING:
                        ...
                        if (lootExists) {
                            ...
                            if (failedLootAttempts >= 5) {
                                CupidBot.log("Failed to find loot 5 times, hopping worlds...");

                                if (Rs2Bank.isOpen()) {
                                    CupidBot.log("Bank is open, closing before hopping...");
                                    Rs2Bank.closeBank();
                                ...
                                CupidBot.hopToWorld(worldNumber);
                ...
                CupidBot.log("Error in DefaultScript: " + ex.getMessage());
            }
    ...
    public boolean handleWalk(AutoLooterConfig config) {
        scheduledFuture = scheduledExecutorService.scheduleWithFixedDelay(() -> {
            try {
                ...
                CupidBot.log("Error in handleWalk: " + ex.getMessage());
            }
